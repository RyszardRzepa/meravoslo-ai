...
export default function SearchTab({ uid, threadId, exampleMessages, name }: ChatTabProps) {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    const places = (await searchForPlaces(inputValue))
    const activities = (await searchForActivities(inputValue))
      ...
      <div>
        ...
        >
          {!isLoading && data.length === 0 ? (
            <>
              <div className="">
                <div className="rounded-lg p-6">
                  <div
                    className={
                      'mb-4 flex h-12 w-12 shrink-0 select-none items-center justify-center rounded-full border' +
                      ' border-peachDark' +
                      ' bg-peach text-primary-foreground'}
                  >
                    <svg width="614" height="613" viewBox="0 0 614 613" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path
            ...
            <div className="p-4 flex flex-col gap-4 mb-28">
              {isLoading ? (
        ...
        />
        {isLimitReached ? (
          <div className="bg-peachLight fixed inset-x-0 bottom-0 w-full ">
              ...
              <div className="px-4 py-2 space-y-4 border-t border-t-peachDark shadow-lg bg-peachLight md:py-4">
                <form ref={formRef} onSubmit={handleSubmit}>
                  <div className="flex flex-row gap-3 justify-center items-center">
                    ...
                    <div className="relative flex flex-col w-full overflow-hidden max-h-60 grow bg-peach border border-peachDark rounded-full pr-14 pl-6 focus-within:ring-2 focus-within:ring-gray-700 focus-within:ring-offset-0">
                    <Textarea
